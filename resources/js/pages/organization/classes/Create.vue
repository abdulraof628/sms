  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    <div class="mx-auto w-full p-6">
      ...
      <div class="flex items-center justify-between mb-6">
        <div>
          <h1 class="text-3xl font-bold text-foreground">Create New Class</h1>
          <p class="text-muted-foreground mt-2">Add a new class to the system with Malaysian education details</p>
        </div>
        <div>
...
const form = useForm({
    ...
    name: '',
    code: '',
    curriculum_type: 'kss', // Default value
    grade_level: 'form_1', // Default value - required
    stream: '', // Optional
    academic_session: new Date().getFullYear() + '/' + (new Date().getFullYear() + 1),
    language_medium: 'malay', // Default value
    capacity: 40,
    advisor_id: '',
    description: '',
    notes: '',
