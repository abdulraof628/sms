...
const recentActivity = [
    { id: 1, type: 'organization', name: 'ABC School District', action: 'created', time: '2 hours ago' },
    { id: 2, type: 'user', name: 'John Doe', action: 'registered', time: '4 hours ago' },
    { id: 3, type: 'tenant', name: 'xyz-school.com', action: 'activated', time: '6 hours ago' },
    { id: 4, type: 'organization', name: 'City High School', action: 'updated', time: '1 day ago' },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-foreground">Business Dashboard</h1>
                    <p class="text-muted-foreground mt-2">System overview and management</p>
                </div>
                <div class="flex items-center space-x-3">
                    <Link :href="route('business.organizations.create')">
                ...
                <Card class="hover:shadow-lg transition-shadow duration-200">
                    ...
                    <CardContent>
                        ...
                        <div class="flex items-center space-x-2 text-xs text-muted-foreground">
                            ...
                            <span>{{ stats.activeOrganizations }} active</span>
                        </div>
                    </CardContent>
                </Card>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card>
                    ...
                    <CardContent class="space-y-3">
                        <Link :href="route('business.organizations.index')" class="block">
                            <Button variant="outline" class="w-full justify-start">
                                <Eye class="h-4 w-4 mr-2" />
                                View All Organizations
                            </Button>
                        </Link>
                        <Link :href="route('business.organizations.create')" class="block">
